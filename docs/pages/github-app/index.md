...
description: Using GitHub Apps for automated security scanning with scheduled workflows
githubEdit: true
---
...
**Questions?** Check the [Getting Started Guide](/pages/getting-started/) or [open a discussion](https://github.com/sdh100shaun/gh-tools/discussions).
