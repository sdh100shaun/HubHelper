...
description: HubHelper's security control catalogue is structured on OSCAL 1.1.2 and maps every control to NIST 800-53 and CIS Controls.
---
...
**OSCAL (Open Security Controls Assessment Language)** is a set of formats published by NIST that express security control catalogues, profiles, and assessment results in machine-readable XML and JSON. HubHelper adopts the OSCAL vocabulary for its own policy layer:
...
- [NIST 800-53 Rev 5](https://csrc.nist.gov/publications/detail/sp/800-53/rev-5/final) — full control catalogue
