...
**OSCAL (Open Security Controls Assessment Language)** is a set of formats published by NIST that express security control catalogs, profiles, and assessment results in machine-readable YAML or JSON. HubHelper adopts the OSCAL vocabulary for its own policy layer:
