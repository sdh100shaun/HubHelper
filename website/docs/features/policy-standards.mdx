...
**OSCAL (Open Security Controls Assessment Language)** is a set of formats published by NIST that express security control catalogs, profiles, and assessment results in machine-readable XML and JSON. HubHelper adopts the OSCAL vocabulary and document model for its own YAML-based policy layer:
